    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        ...
        packages.default = stdenv.mkDerivation {
          ...
          buildInputs = [ unstable.SDL2 unstable.curl unstable.openssl unstable.sqlite unstable.SDL2_image unstable.libtiff unstable.lerc unstable.tinyxml-2 ]
        ...
        checks.default = stdenv.mkDerivation {
          ...
          src = ./.;
          nativeBuildInputs = [ unstable.cmake unstable.ninja unstable.pkg-config unstable.git unstable.cacert ];
          buildInputs = [ unstable.SDL2 unstable.curl unstable.openssl unstable.sqlite unstable.SDL2_image unstable.libtiff unstable.tinyxml2 ]
            ++ (unstable.lib.optionals (unstable.stdenv.isDarwin) (darwinFrameworks ++ [ unstable.libcxx ]))
            ++ (unstable.lib.optionals (!unstable.stdenv.isDarwin) [ unstable.libGL ]);
