        ...
        std::string generate_metadata(const std::string& email_content) {
            try {
                ...
                if (existing) {
                    ...
                    auto write_result = glz::write_json(*existing, json_result);
                    if (write_result) {
                        return "{}"; // Return empty JSON on serialization error
                    }
                    return json_result;
                }
                ...
                if (result) {
                    ...
                    std::string json_result;
                    auto write_result = glz::write_json(fallback, json_result);
                    if (write_result) {
                        return "{}"; // Return empty JSON on serialization error
                    }
                    return json_result;
                ...
                std::string json_result;
                auto write_result = glz::write_json(error_metadata, json_result);
                if (write_result) {
                    return "{}"; // Return empty JSON on serialization error
                }
                return json_result;
