...
#define RSS_ERROR_FMT(fmt, ...) RSS_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RSS_WARN_FMT(fmt, ...) RSS_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RSS_INFO_FMT(fmt, ...) RSS_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RSS_DEBUG_FMT(fmt, ...) RSS_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RSS_TRACE_FMT(fmt, ...) RSS_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Weather component format macros
#define WEATHER_ERROR_FMT(fmt, ...) WEATHER_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WEATHER_WARN_FMT(fmt, ...) WEATHER_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WEATHER_INFO_FMT(fmt, ...) WEATHER_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WEATHER_DEBUG_FMT(fmt, ...) WEATHER_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WEATHER_TRACE_FMT(fmt, ...) WEATHER_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// SQLite format macros - renamed to avoid conflict
#define DB_ERROR_FMT(fmt, ...) DB_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define DB_WARN_FMT(fmt, ...) DB_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define DB_INFO_FMT(fmt, ...) DB_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define DB_DEBUG_FMT(fmt, ...) DB_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define DB_TRACE_FMT(fmt, ...) DB_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Window component format macros
#define WND_ERROR_FMT(fmt, ...) WND_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WND_WARN_FMT(fmt, ...) WND_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WND_INFO_FMT(fmt, ...) WND_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WND_DEBUG_FMT(fmt, ...) WND_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define WND_TRACE_FMT(fmt, ...) WND_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Git component format macros
#define GIT_ERROR_FMT(fmt, ...) GIT_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define GIT_WARN_FMT(fmt, ...) GIT_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define GIT_INFO_FMT(fmt, ...) GIT_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define GIT_DEBUG_FMT(fmt, ...) GIT_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define GIT_TRACE_FMT(fmt, ...) GIT_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Animation component format macros
#define ANIM_ERROR_FMT(fmt, ...) ANIM_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define ANIM_WARN_FMT(fmt, ...) ANIM_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define ANIM_INFO_FMT(fmt, ...) ANIM_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define ANIM_DEBUG_FMT(fmt, ...) ANIM_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define ANIM_TRACE_FMT(fmt, ...) ANIM_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Radio component format macros
#define RADIO_ERROR_FMT(fmt, ...) RADIO_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RADIO_WARN_FMT(fmt, ...) RADIO_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RADIO_INFO_FMT(fmt, ...) RADIO_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RADIO_DEBUG_FMT(fmt, ...) RADIO_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define RADIO_TRACE_FMT(fmt, ...) RADIO_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Notification service format macros
#define NOTIFY_ERROR_FMT(fmt, ...) NOTIFY_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define NOTIFY_WARN_FMT(fmt, ...) NOTIFY_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define NOTIFY_INFO_FMT(fmt, ...) NOTIFY_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define NOTIFY_DEBUG_FMT(fmt, ...) NOTIFY_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define NOTIFY_TRACE_FMT(fmt, ...) NOTIFY_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// System/app format macros
#define SYS_ERROR_FMT(fmt, ...) SYS_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define SYS_WARN_FMT(fmt, ...) SYS_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define SYS_INFO_FMT(fmt, ...) SYS_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define SYS_DEBUG_FMT(fmt, ...) SYS_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define SYS_TRACE_FMT(fmt, ...) SYS_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Chess component format macros
#define CHESS_ERROR_FMT(fmt, ...) CHESS_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define CHESS_WARN_FMT(fmt, ...) CHESS_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define CHESS_INFO_FMT(fmt, ...) CHESS_INFO(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define CHESS_DEBUG_FMT(fmt, ...) CHESS_DEBUG(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define CHESS_TRACE_FMT(fmt, ...) CHESS_TRACE(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))

// Video feed component format macros
#define VIDEOFEED_ERROR_FMT(fmt, ...) VIDEOFEED_ERROR(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
#define VIDEOFEED_WARN_FMT(fmt, ...) VIDEOFEED_WARN(debug::format_log(fmt __VA_OPT__(,) __VA_ARGS__))
