...
struct media_player {
    ...
    static inline RouenGPUTexture* s_unlit_vu_texture{nullptr};
    static inline SDL_GPUTransferBuffer* s_unlit_vu_transfer_buf{nullptr};
    static inline std::mutex s_unlit_vu_mutex;
