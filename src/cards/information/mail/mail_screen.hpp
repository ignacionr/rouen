                ...
                for (auto uid : new_uids) {
                    ...
                    pending_tasks_.push_back([this, uid, msg]() {
                        try {
                            ...
                            // Process metadata using external service (would be integrated with an AI service)
                            // For now, we'll use a simple placeholder
                            // NOTE: In a real implementation, you would call an AI service here
                            std::string metadata_json = R"({
                                "urgency": 2,
                                "category": "updates",
                                "summary": "This is an automatically generated summary of the email.",
                                "tags": ["sample", "email"]
                            })";
