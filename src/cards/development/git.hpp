...
struct git : public card {
    ...
    void fetch_recent_commits_7d_async(const std::string& repo_path);
    void fetch_commit_detail_async(const std::string& repo_path, const std::string& commit_hash);
