...
* 🧩 **[Plugin Guide](docs/PLUGINS.md)**: Adding new card types and URI registrations from dynamically loaded libraries, with a buildable sample plugin under `plugins/sample-card-plugin/`.
